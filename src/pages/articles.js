...
import article4 from "../../public/images/articles/form.png"
...
const FeaturedArticle = ({ img, title, time, summary, link }) => {
    return (
        <li className='relative w-full p-4 bg-light border border-solid border-dark rounded-2xl dark:bg-dark dark:border-light'>
            ...
            <Link href={link} target='_blank'>
                <h2 className='mt-4 capitalize text-2xl font-bold my-2 hover:underline xs:text-lg'>{title}</h2>
            </Link>
