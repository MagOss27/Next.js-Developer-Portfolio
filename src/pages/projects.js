...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
    return (
        <article className='rounded-br-2xl w-full flex relative items-cente justify-between rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12'>
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6'>
                ...
                <Link href={link} target='_blank' className='hover:underline underline'>
...
const Project = ({ title, type, img, link, github }) => {
    return (
        <article className='w-full flex-col relative items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6'>
            ...
            <div className='w-full flex flex-col items-start justify-between mt-4'>
                ...
                <div className='w-full mt-2 flex items- justify-between'>
